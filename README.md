...
| Paper Title                                                  | Link to code | Presenters | Notes                                      |
| ------------------------------------------------------------ | ------------ | ---------- | ------------------------------------------ |
| [Delphi: A Cryptographic Inference Service for Neural Networks](https://www.usenix.org/system/files/sec20-mishra_0.pdf) (Security 2020) | (https://github.com/mc2-project/delphi) | Dan | [Summary](./Security/2022/Delphi/Delphi.md) |
